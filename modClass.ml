...
let initialize {Interp.eva={Eva.env}} =
  ...
  Eva.Env.add_method mod_class_open "Class::C" ">" Eva.subr_gt ~export:true;
  Eva.Env.add_method mod_class_open "Class::C" "<" Eva.subr_lt ~export:true;
  Eva.Env.add_method mod_class_open "Class::C" ">=" Eva.subr_ge ~export:true;
  Eva.Env.add_method mod_class_open "Class::C" "<=" Eva.subr_le ~export:true;
  ...
  Eva.Env.add_method mod_class_open "Class::C" "<=>" Eva.subr_compare ~export:true;
