...
let make_binary_op proc = Eva.make_binary_subr Eva.value_of_int proc Eva.int_of_value
...
let initialize {Interp.eva={Eva.env}} =
  ...
  Eva.Env.add_method mod_int_open "Int::C" ">" Eva.subr_gt ~export:true;
  Eva.Env.add_method mod_int_open "Int::C" "<" Eva.subr_lt ~export:true;
  Eva.Env.add_method mod_int_open "Int::C" ">=" Eva.subr_ge ~export:true;
  ...
  Eva.Env.add_method mod_int_open "Int::C" "*" (make_binary_op ( * )) ~export:true;
  Eva.Env.add_method mod_int_open "Int::C" "/" (make_binary_op ( / )) ~export:true;
  Eva.Env.add_method mod_int_open "Int::C" "%" (make_binary_op ( mod )) ~export:true;
